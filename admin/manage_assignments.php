...
<head>
    ...
    <title>ASSIGNMENTS | ADMIN | VIT CRMS</title>
</head>
<body>
                            ...
                            <?php
                                ...
                                if ($num > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>" . $row['assignment_course_name'] ."</td>
                                        <td>" . $row['assignment_faculty_name'] ."</td>
                                        <td>" . $row['assignment_download'] ."</td>
                                        <td>" . $row['assignment_time'] ."</td>
                                        <td>
                                            <button class='delete' id='del" . $row['assignment_id'] . "'>DELETE</button>
                                        </td>
                                        </tr>
                                        ";
                                        $i++;
      ...
      Array.from(deletes).forEach((element)=>{
        element.addEventListener('click', (e)=>{
          ...
          if(confirm("Are you Sure!")){
            console.log("YES");
            window.location = `./manage_assignments.php?delete=${sno}`;
          }
          else{
            console.log("NO");
          }
